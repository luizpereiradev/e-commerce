...
export default function Countdown() {
  ...
  return (
    <div className="lg:w-full sm:text-base text-sm w-1/2 lg:justify-start justify-end sm:h-16 h-12 lg:h-12 grid grid-flow-col gap-1 text-center auto-cols-max mr-3 lg:mr-0">
      <div className="rounded-lg gap-1 sm:w-16 items-center sm:justify-center lg:w-12 flex w-12 flex-col p-2 bg-gray-200 text-gray-700">
      ...
      <div className="rounded-lg gap-1 sm:w-16 sm:justify-center lg:w-12 items-center w-12 flex flex-col p-2  bg-gray-200 text-gray-700">
        <span className="countdown font-mono">
      ...
      <div className="rounded-lg gap-1 sm:w-16 sm:justify-center items-center lg:w-12 w-12 flex flex-col p-2 bg-gray-200 text-gray-700">
        <span className="countdown font-mono">
